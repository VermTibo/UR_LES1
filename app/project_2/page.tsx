    ...
    <div className="max-w-6xl mx-auto px-6 py-12 space-y-20 text-white min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
        <div className="space-y-4">
          <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-green to-orange-500 uppercase">
             Beachvolleybal Antwerpen
          </h1>
          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-light tracking-widest text-zinc-500 italic">
                Focus: Actie, dynamiek en locatie
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 text-zinc-400 leading-relaxed text-lg">
          <p>
            Zand, zweet en uiterste concentratie midden in de stad. In deze fotoreportage leg ik de dynamiek vast van een beachvolleybaltoernooi in hartje Antwerpen. De uitdaging was om de intensiteit van de sport te combineren met de unieke stedelijke achtergrond. Door dicht op de actie te zitten, heb ik de emotie van de spelers en de energie van het publiek weten te bevriezen in beelden die het verhaal vertellen van een zomerse dag vol competitie en passie.
          </p>
        </div>
      </div>
