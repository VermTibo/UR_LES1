...
export default function AboutPage() {
  ...
  const gridItems = [
    { id: 1, size: "md:col-span-2 md:row-span-2", img: "/projects/cinecity/img1.jpg" },
    { id: 2, size: "md:col-span-1 md:row-span-1", img: "/projects/cinecity/img2.jpg" },
    { id: 3, size: "md:col-span-1 md:row-span-2", img: "/projects/cinecity/img3.jpg" },
    { id: 4, size: "md:col-span-2 md:row-span-1", img: "/projects/cinecity/img4.jpg" },
    { id: 5, size: "md:col-span-3 md:row-span-1", img: "/projects/cinecity/img5.jpg" },
  ];
    ...
    <div className="max-w-6xl mx-auto px-6 py-12 space-y-20 text-white min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
        <div className="space-y-4">
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-transparent bg-clip-text bg-linear-to-b from-blue-500 to-cyan-500 uppercase">
            CineCity
          </h1>
        ...
        <div className="space-y-6 text-zinc-400 leading-relaxed text-lg">
          <p>
            Wanneer de zon ondergaat, komt de stad tot leven in een zee van licht.
            Voor het filmfestival CineCity heb ik een visuele identiteit ontwikkeld
            die de rauwe, energieke sfeer van het nachtelijke stadsleven vangt.
          </p>
        </div>
      </div>
        ...
        {gridItems.map((item) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-linear-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-8">
               <p className="text-cyan-400 text-sm font-bold tracking-widest uppercase">Bekijk Detail</p>
            </div>
          </div>
        ))}
      </div>
